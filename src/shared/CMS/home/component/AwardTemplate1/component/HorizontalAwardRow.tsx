...
interface HorizontalAwardRowInterface {
    data?: Array<any>,
    onPressBrand?: (data: any) => void
}

const HorizontalAwardRow: FC<HorizontalAwardRowInterface> = ({
    data = [],
    onPressBrand
}) => {

    const { width } = useScaledDimensions()
    const ITEM_WIDTH = useMemo(() => width / 7.5, [width]);
...
export default React.memo(HorizontalAwardRow)
